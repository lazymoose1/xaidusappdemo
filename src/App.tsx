...
const AppContent = () => {
  ...
  return (
    <div ref={swipeRef} className="min-h-screen">
      ...
      {!location.pathname.startsWith('/auth') && location.pathname !== '/parent-signup' && location.pathname !== '/onboarding' && location.pathname !== '/scout-onboarding' && location.pathname !== '/leader' && (
        <BottomNav />
      )}
    </div>
  );
