...
const envSchema = z.object({
  ...
  SOCIAL_PROFILE_SCRAPER_URL: z.string().url().optional(),
  SOCIAL_PROFILE_SCRAPER_API_KEY: z.string().min(1).optional(),
  SOCIAL_PROFILE_SCRAPER_TIMEOUT_MS: z.coerce.number().int().positive().max(10000).default(3500),
